...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void addTodo() {
    setState(() {
      todos.add(todoTitleController.text);
      completed.add(false);
  ...
  void deleteTodo(String todo, int index) {
    setState(() {
      todos.remove(todo);
          ...
          children: [
            Expanded(
              child: CheckboxListTile(
                title: Text(todos.elementAt(i)),
                value: completed.elementAt(i),
                onChanged: (value) {
                  setState(() {
                    completed[i] = value!;
                  });
            ...
            ElevatedButton(
                onPressed: () {
                  deleteTodo(todos.elementAt(i), i);
                },
